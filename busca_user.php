...
require_once 'include/menu.php';
    ...
    //Se status for alterar Exibira os dados do cliente e o botao muda para alterar
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" class="mt-5 col-md-8 col-12 mx-auto border py-4 bg-light font-arial">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-6">
                    ...
                    <input class="form-control" type="text" name="cpf" id="rg" value="<?php echo $data['cpf']?>">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-6">
                    ...
                    <input class="form-control" type="text" name="endereco" id="endereco" value="<?php echo $data['endereco']?>">
                    <!--  
           ...
           <!--  <div class="form-row">
                <div class="form-group col-8">
                    <label for="endereco">endereco</label>
                    <input class="form-control" type="text" name="endereco" id="endereco" value="<?php echo $data['endereco']?>" required>
                </div>
    ...
    <?php
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" class="mt-5 col-md-8 col-12 mx-auto border py-4 bg-light font-arial rounded">
...
<?php
    ...
    if(isset($_POST['nome']) || isset($_POST['cpf'])){
        ...
        if(isset($_POST['alterar'])){
            ...
            $estado = $_POST['estado'];
            $cep = $_POST['cep']; */
            $sql = "UPDATE clientes SET nome='$nome', cpf='$cpf', telefone='$telefone',/*  celular='$celular', */ endereco='$endereco', /* bairro='$bairro',cidade='$cidade', estado='$estado', cep='$cep' */ WHERE id = $id";
